            ...
            <main className={styles.main}>
                ...
                <div className={styles.serviceSection}>
                    <div>
                        ...
                        <h5>
                            Wifinitive Cloud Services offer innovative solutions for enterprises looking to streamline their cloud offerings and
                ...
                <div className={styles.digitalServices}>
                    ...
                    <div className={styles.imageContainer}>
                        <Image src={DigitalServices} layout={'intrinsic'} />
                    </div>
                </div>
                <div className={styles.serviceSection}>
                    <div>
                        <h3>
                            <span>Technology</span> Services
                        </h3>
                        <h5>
                            Wifinitive reinvents through technology to build better business. We start at the foundations of your business and provide
                            innovation at both the edge and core while also working with you to understand how you define your business success path.
                        </h5>
                        <a href={'/services/technology'}>Learn more</a>
                    </div>
                    {windowWidth > 850 ? (
                        <div>
                            <svg width={422} height={257} fill={'none'} xmlns={'http://www.w3.org/2000/svg'}>
                    ...
                    <Image src={TechnologySolutionsBars} layout={'fill'} objectPosition={'bottom'} objectFit={'cover'} />
                </div>
            </main>
            <Footer />
        </>
